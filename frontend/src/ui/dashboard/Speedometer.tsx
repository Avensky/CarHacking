...
export default function Speedometer({ speed, scale }: { speed: number, scale: number }) {
    ...
    useEffect(() => {
        ...
        const drawGauge = () => {
            ...
            //     const ratio = speedValue / maxSpeed;
            //     const angle = startAngle + ratio * (endAngle - startAngle);
            //     const tickX1 = centerX + (radius - tickLineLength) * Math.cos(angle);
            //     const tickY1 = centerY + (radius - tickLineLength) * Math.sin(angle);
            //     const tickX2 = centerX + radius * Math.cos(angle);
            //     const tickY2 = centerY + radius * Math.sin(angle);
            ...
            //     ctx.moveTo(tickX1, tickY1);
            //     ctx.lineTo(tickX2, tickY2);
            //     ctx.lineWidth = tickLineWidth;   // ✅ thinner tick line
            //     ctx.strokeStyle = tickColor;     // ✅ separate tick color
            //     ctx.stroke();
